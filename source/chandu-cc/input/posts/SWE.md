...
* Lose the **ego**  
  * Important to be humble, that doesn’t mean you need to be a doormat;  
  * Ego manifests in many ways  
  * Lot of time it can get in the way of your productivity and slow you down.

* Learn to give and take **criticism**  
  * In a professional software engineering env, criticism is almost never personal.  
  * The person giving constructive criticism genuinely cares about the other person and wants them to improve themselves or their work.  
  * Trusting that the other person has your best interests at heart and doesn’t actually think you're an idiot.  
  * Your self-worth shouldn’t be connected to cod you write
...
5. A set of action items to fix the problem immediately  
6. A set of action items the event from happening again  
7. Lessons learned 
...
1. Your organization understands your problems better than random people on the internet.  
2. You need mechanisms to **distributed** the knowledge   
3. Your organization needs **culture** for learning.  
4. **Psychological safety** that permits people to admit to  a lack of knowledge. 
...
### Antipatterns : ignore low performers
